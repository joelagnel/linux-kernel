...
{
	/*
	 * Wait till the core of this HT is in a core-wide IRQ state.
	 *
...
/*
 * Process any work need for either exiting the core-wide IRQ state, or for waiting
 * on this hyperthread if the core is still in this state.
 */
